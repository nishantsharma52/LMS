...
const Profile = () => {
    ...
    const {user} = data;
    return (
        <div className='my-24 px-4 mx-auto max-w-4xl'>
            ...
            <div>
                ...
                <div className='grid grid-cols-1 sm: grid-cols-2 md:grid-cols-3 gap-4 my-5'>
                    {
                       user.enrolledCoures.length === 0 ? <h1>you haven't enrolled yet</h1> : (
                           user.enrolledCoures.map((course) => <Course course={course} key={course._id} />)
                        )
                    }
                </div>
            </div>
